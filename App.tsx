...
const App: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* 1. Hero — Three.js 3D scene */}
      <HeroScene isDark={isDark} />

      {/* Marquee ticker */}
      <Marquee isDark={isDark} items={MARQUEE_ITEMS} />

      {/* 2. Services — GSAP horizontal pinned scroll */}
      <ServicesSection isDark={isDark} />

      {/* 3. Process — GSAP scroll reveals */}
      <ProcessSection isDark={isDark} />

      {/* 4. Portfolio — 3D tilt cards + filter */}
      ...
      <div className="fixed bottom-10 left-10 z-[90] hidden lg:block">
        <div className="flex items-center gap-4">
          ...
          <div className={`text-[9px] font-black tracking-[0.3em] uppercase ${isDark ? 'text-white/40' : 'text-black/40'}`}>
      ...
      <div className="fixed bottom-10 right-10 z-[90] hidden lg:block">
        <div className={`text-[9px] font-black tracking-[0.3em] uppercase rotate-90 origin-right ${isDark ? 'text-white/40' : 'text-black/40'}`}>
